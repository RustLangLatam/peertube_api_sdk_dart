...
part 'video_channel_list_data_inner.g.dart';
...
/// * [ownerAccount]
@BuiltValue()
abstract class VideoChannelListDataInner
    implements
        Actor,
        VideoChannel,
        Built<VideoChannelListDataInner, VideoChannelListDataInnerBuilder> {
  VideoChannelListDataInner._();

  factory VideoChannelListDataInner(
          [void updates(VideoChannelListDataInnerBuilder b)]) =
      _$VideoChannelListDataInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(VideoChannelListDataInnerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<VideoChannelListDataInner> get serializer =>
      _$VideoChannelListDataInnerSerializer();
}

class _$VideoChannelListDataInnerSerializer
    implements PrimitiveSerializer<VideoChannelListDataInner> {
  @override
  ...
  @override
  final String wireName = r'VideoChannelListDataInner';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    VideoChannelListDataInner object, {
  ...
  void _deserializeProperties(
    ...
    required VideoChannelListDataInnerBuilder result,
  ...
  @override
  VideoChannelListDataInner deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = VideoChannelListDataInnerBuilder();

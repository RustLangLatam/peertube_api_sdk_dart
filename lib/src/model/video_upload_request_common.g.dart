...
part of 'video_upload_request_common.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

abstract mixin class VideoUploadRequestCommonBuilder {
  void replace(VideoUploadRequestCommon other);

  void update(void Function(VideoUploadRequestCommonBuilder) updates);
  ...
  set privacy(VideoPrivacySet? privacy);
  ...
  set generateTranscription(bool? generateTranscription);
  ...
  SetBuilder<String> get tags;

  set tags(SetBuilder<String>? tags);

  bool? get commentsEnabled;

  set commentsEnabled(bool? commentsEnabled);

  VideoCommentsPolicySet? get commentsPolicy;

  set commentsPolicy(VideoCommentsPolicySet? commentsPolicy);

  bool? get downloadEnabled;

  set downloadEnabled(bool? downloadEnabled);
  ...
  set scheduleUpdate(VideoScheduledUpdateBuilder? scheduleUpdate);

  Uint8List? get thumbnailfile;

  set thumbnailfile(Uint8List? thumbnailfile);

  Uint8List? get previewfile;

  set previewfile(Uint8List? previewfile);

  SetBuilder<String> get videoPasswords;

  set videoPasswords(SetBuilder<String>? videoPasswords);
}

class _$$VideoUploadRequestCommon extends $VideoUploadRequestCommon {
  @override
  final String name;
  @override
  final int channelId;
  ...
  factory _$$VideoUploadRequestCommon(
          [void Function($VideoUploadRequestCommonBuilder)? updates]) =>
      (new $VideoUploadRequestCommonBuilder()..update(updates))._build();

  _$$VideoUploadRequestCommon._(
      {required this.name,
    ...
    BuiltValueNullFieldError.checkNotNull(
        name, r'$VideoUploadRequestCommon', 'name');
    BuiltValueNullFieldError.checkNotNull(
        channelId, r'$VideoUploadRequestCommon', 'channelId');
  }

  @override
  $VideoUploadRequestCommon rebuild(
          void Function($VideoUploadRequestCommonBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  $VideoUploadRequestCommonBuilder toBuilder() =>
      new $VideoUploadRequestCommonBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is $VideoUploadRequestCommon &&
        name == other.name &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'$VideoUploadRequestCommon')
          ..add('name', name)
...
class $VideoUploadRequestCommonBuilder
    implements
        Builder<$VideoUploadRequestCommon, $VideoUploadRequestCommonBuilder>,
        VideoUploadRequestCommonBuilder {
  _$$VideoUploadRequestCommon? _$v;
  ...
  $VideoUploadRequestCommonBuilder() {
    $VideoUploadRequestCommon._defaults(this);
  }

  $VideoUploadRequestCommonBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _name = $v.name;
  ...
  @override
  void replace(covariant $VideoUploadRequestCommon other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$$VideoUploadRequestCommon;
  }
  ...
  @override
  $VideoUploadRequestCommon build() => _build();

  _$$VideoUploadRequestCommon _build() {
    _$$VideoUploadRequestCommon _$result;
    try {
      _$result = _$v ??
          new _$$VideoUploadRequestCommon._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'$VideoUploadRequestCommon', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);

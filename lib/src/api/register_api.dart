...
class RegisterApi {
  ...
  Future<Response<void>> acceptRegistration({
    ...
    final _path = r'/api/v1/users/registrations/{registrationId}/accept'
        .replaceAll(
            '{' r'registrationId' '}',
            encodeQueryParameter(
                    _serializers, registrationId, const FullType(int))
                .toString());
    ...
    try {
      const _type = FullType(UserRegistrationAcceptOrReject);
      _bodyData = userRegistrationAcceptOrReject == null
          ? null
          : _serializers.serialize(userRegistrationAcceptOrReject,
              specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteRegistration({
    required int registrationId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/users/registrations/{registrationId}'.replaceAll(
        '{' r'registrationId' '}',
        encodeQueryParameter(_serializers, registrationId, const FullType(int))
            .toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
  ...
  Future<Response<ListRegistrations200Response>> listRegistrations({
    ...
    final _path = r'/api/v1/users/registrations';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> registerUser({
    ...
    final _path = r'/api/v1/users/register';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> rejectRegistration({
    required int registrationId,
    UserRegistrationAcceptOrReject? userRegistrationAcceptOrReject,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/v1/users/registrations/{registrationId}/reject'
        .replaceAll(
            '{' r'registrationId' '}',
            encodeQueryParameter(
                    _serializers, registrationId, const FullType(int))
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserRegistration] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserRegistration>> requestRegistration({
    ...
    final _path = r'/api/v1/users/registrations/request';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(UserRegistrationRequest);
      _bodyData = userRegistrationRequest == null
          ? null
          : _serializers.serialize(userRegistrationRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
    ...
    UserRegistration? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(UserRegistration),
            ) as UserRegistration;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> resendEmailToVerifyRegistration({
    ResendEmailToVerifyRegistrationRequest?
        resendEmailToVerifyRegistrationRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/v1/users/registrations/ask-send-verify-email';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ResendEmailToVerifyRegistrationRequest);
      _bodyData = resendEmailToVerifyRegistrationRequest == null
          ? null
          : _serializers.serialize(resendEmailToVerifyRegistrationRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> verifyRegistrationEmail({
    required int registrationId,
    ...
    final _path = r'/api/v1/users/registrations/{registrationId}/verify-email'
        .replaceAll(
            '{' r'registrationId' '}',
            encodeQueryParameter(
                    _serializers, registrationId, const FullType(int))
    ...
    try {
      const _type = FullType(VerifyRegistrationEmailRequest);
      _bodyData = verifyRegistrationEmailRequest == null
          ? null

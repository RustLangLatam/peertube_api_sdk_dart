...
class VideoFilesApi {
  ...
  const VideoFilesApi(this._dio, this._serializers);
  ...
  Future<Response<void>> delVideoHLS({
    ...
    final _path = r'/api/v1/videos/{id}/hls'.replaceAll(
        '{' r'id' '}',
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> delVideoWebVideos({
    required ApiV1VideosOwnershipIdAcceptPostIdParameter id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/videos/{id}/web-videos'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id,
                const FullType(ApiV1VideosOwnershipIdAcceptPostIdParameter))
            .toString());

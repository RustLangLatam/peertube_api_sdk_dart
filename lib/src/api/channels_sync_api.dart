...
class ChannelsSyncApi {
  final Dio _dio;

  final Serializers _serializers;

  const ChannelsSyncApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AddVideoChannelSync200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AddVideoChannelSync200Response>> addVideoChannelSync({
    ...
    final _path = r'/api/v1/video-channel-syncs';
    ...
    try {
      const _type = FullType(VideoChannelSyncCreate);
      _bodyData = videoChannelSyncCreate == null
          ? null
          : _serializers.serialize(videoChannelSyncCreate,
              specifiedType: _type);
    ...
    AddVideoChannelSync200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(AddVideoChannelSync200Response),
            ) as AddVideoChannelSync200Response;
    } catch (error, stackTrace) {
      throw DioException(
    ...
    return Response<AddVideoChannelSync200Response>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> delVideoChannelSync({
    required int channelSyncId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/video-channel-syncs/{channelSyncId}'.replaceAll(
        '{' r'channelSyncId' '}',
        encodeQueryParameter(_serializers, channelSyncId, const FullType(int))
            .toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> triggerVideoChannelSync({
    required int channelSyncId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/video-channel-syncs/{channelSyncId}/sync'
        .replaceAll(
            '{' r'channelSyncId' '}',
            encodeQueryParameter(
                    _serializers, channelSyncId, const FullType(int))
                .toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{

...
class VideoTranscodingApi {
  final Dio _dio;

  final Serializers _serializers;

  const VideoTranscodingApi(this._dio, this._serializers);
  ...
  Future<Response<void>> createVideoTranscoding({
    ...
    final _path = r'/api/v1/videos/{id}/transcoding'.replaceAll(
        '{' r'id' '}',
    ...
    try {
      const _type = FullType(CreateVideoTranscodingRequest);
      _bodyData = createVideoTranscodingRequest == null
          ? null
          : _serializers.serialize(createVideoTranscodingRequest,
              specifiedType: _type);

...
class MyNotificationsApi {
  ...
  Future<Response<void>> apiV1UsersMeNotificationSettingsPut({
    ApiV1UsersMeNotificationSettingsPutRequest?
        apiV1UsersMeNotificationSettingsPutRequest,
    ...
    final _path = r'/api/v1/users/me/notification-settings';
    ...
    try {
      const _type = FullType(ApiV1UsersMeNotificationSettingsPutRequest);
      _bodyData = apiV1UsersMeNotificationSettingsPutRequest == null
          ? null
          : _serializers.serialize(apiV1UsersMeNotificationSettingsPutRequest,
              specifiedType: _type);
  ...
  ///
  /// Parameters:
  /// * [unread] - only list unread notifications
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationListResponse>> apiV1UsersMeNotificationsGet({
    bool? unread,
    int? start,
    int? count = 15,
    String? sort,
    ...
    final _path = r'/api/v1/users/me/notifications';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (unread != null)
        r'unread':
            encodeQueryParameter(_serializers, unread, const FullType(bool)),
      if (start != null)
        r'start':
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiV1UsersMeNotificationsReadAllPost({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/users/me/notifications/read-all';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiV1UsersMeNotificationsReadPost({
    ApiV1UsersMeNotificationsReadPostRequest?
        apiV1UsersMeNotificationsReadPostRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/v1/users/me/notifications/read';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ApiV1UsersMeNotificationsReadPostRequest);
      _bodyData = apiV1UsersMeNotificationsReadPostRequest == null
          ? null
          : _serializers.serialize(apiV1UsersMeNotificationsReadPostRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(

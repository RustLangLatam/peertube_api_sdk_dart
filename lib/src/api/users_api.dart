...
class UsersApi {
  ...
  ///
  /// Parameters:
  /// * [addUser] - If the smtp server is configured, you can leave the password empty and an email will be sent asking the user to set it first.
  ...
  Future<Response<AddUserResponse>> addUser({
    ...
    try {
      const _type = FullType(AddUser);
      _bodyData = _serializers.serialize(addUser, specifiedType: _type);
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(AddUserResponse),
            ) as AddUserResponse;
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> confirmTwoFactorRequest({
    required int id,
    ...
    final _path = r'/api/v1/users/{id}/two-factor/confirm-request'.replaceAll(
        '{' r'id' '}',
    ...
    try {
      const _type = FullType(ConfirmTwoFactorRequestRequest);
      _bodyData = confirmTwoFactorRequestRequest == null
          ? null
          : _serializers.serialize(confirmTwoFactorRequestRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> disableTwoFactor({
    required int id,
    ...
    final _path = r'/api/v1/users/{id}/two-factor/disable'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
    ...
    try {
      const _type = FullType(RequestTwoFactorRequest);
      _bodyData = requestTwoFactorRequest == null
          ? null
          : _serializers.serialize(requestTwoFactorRequest,
              specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
  ...
  /// Parameters:
  /// * [id] - Entity id
  /// * [withStats] - include statistics about the user (only available as a moderator/admin)
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  ///
  /// Parameters:
  /// * [search] - Plain text search that will match with user usernames or emails
  /// * [blocked] - Filter results down to (un)banned users
  /// * [start] - Offset used to paginate results
  /// * [count] - Number of items to return
  /// * [sort] - Sort users by criteria
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<BuiltList<User>>> getUsers({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (blocked != null)
        r'blocked':
            encodeQueryParameter(_serializers, blocked, const FullType(bool)),
      if (start != null)
        r'start':
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<RequestTwoFactorResponse>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<RequestTwoFactorResponse>>> requestTwoFactor({
    required int id,
    RequestTwoFactorRequest? requestTwoFactorRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/v1/users/{id}/two-factor/request'.replaceAll(
        '{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
    ...
    BuiltList<RequestTwoFactorResponse>? _responseData;
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              ...
              specifiedType: const FullType(
                  BuiltList, [FullType(RequestTwoFactorResponse)]),
            ) as BuiltList<RequestTwoFactorResponse>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<RequestTwoFactorResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,

...
class SessionApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [OAuthClient] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<OAuthClient>> getOAuthClient({
    ...
    final _path = r'/api/v1/oauth-clients/local';
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(OAuthClient),
            ) as OAuthClient;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetOAuthToken200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetOAuthToken200Response>> getOAuthToken({
    String? clientId,
    String? clientSecret,
    String? grantType,
    String? username,
    ...
    final _path = r'/api/v1/users/token';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetOAuthToken200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(GetOAuthToken200Response),
            ) as GetOAuthToken200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<GetOAuthToken200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> revokeOAuthToken({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/users/revoke-token';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,

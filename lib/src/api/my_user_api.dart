...
class MyUserApi {
  ...
  const MyUserApi(this._dio, this._serializers);
  ...
  Future<Response<void>> apiV1UsersMeAvatarDelete({
  ...
  Future<Response<ApiV1UsersMeAvatarPickPost200Response>>
    ...
    final _path = r'/api/v1/users/me/avatar/pick';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiV1UsersMeVideoQuotaUsedGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiV1UsersMeVideoQuotaUsedGet200Response>>
    ...
    final _path = r'/api/v1/users/me/video-quota-used';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ApiV1UsersMeVideoQuotaUsedGet200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType:
                  const FullType(ApiV1UsersMeVideoQuotaUsedGet200Response),
            ) as ApiV1UsersMeVideoQuotaUsedGet200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ApiV1UsersMeVideoQuotaUsedGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<User>>> getUserInfo({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> putUserInfo({
    ...
    try {
      const _type = FullType(UpdateMe);
      _bodyData = _serializers.serialize(updateMe, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,

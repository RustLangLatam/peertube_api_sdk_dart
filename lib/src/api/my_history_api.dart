...
class MyHistoryApi {
  ...
  const MyHistoryApi(this._dio, this._serializers);
  ...
  Future<Response<VideoListResponse>> apiV1UsersMeHistoryVideosGet({
    int? start,
    int? count = 15,
    String? search,
    ...
    final _path = r'/api/v1/users/me/history/videos';
  ...
  ///
  /// Parameters:
  /// * [beforeDate] - history before this date will be deleted
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiV1UsersMeHistoryVideosRemovePost({
    DateTime? beforeDate,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/users/me/history/videos/remove';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      _bodyData = FormData.fromMap(<String, dynamic>{
        if (beforeDate != null)
          r'beforeDate': encodeFormParameter(
              _serializers, beforeDate, const FullType(DateTime)),
      });
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiV1UsersMeHistoryVideosVideoIdDelete({
    ...
    final _path = r'/api/v1/users/me/history/videos/{videoId}'.replaceAll(
        '{' r'videoId' '}',
